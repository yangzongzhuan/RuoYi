...
-- 菜单 SQL
insert into sys_menu (menu_name, parent_id, order_num, url, menu_type, visible, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询管理员', '2000', '1', '/park/queryAdmin', 'C', '0', 'park:queryAdmin:view', '#', 'admin', sysdate(), '', null, '查询管理员菜单');
...
-- 按钮 SQL
insert into sys_menu (menu_name, parent_id, order_num, url, menu_type, visible, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询管理员查询', @parentId, '1',  '#',  'F', '0', 'park:queryAdmin:list',         '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, url, menu_type, visible, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询管理员新增', @parentId, '2',  '#',  'F', '0', 'park:queryAdmin:add',          '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, url, menu_type, visible, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询管理员修改', @parentId, '3',  '#',  'F', '0', 'park:queryAdmin:edit',         '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, url, menu_type, visible, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询管理员删除', @parentId, '4',  '#',  'F', '0', 'park:queryAdmin:remove',       '#', 'admin', sysdate(), '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, url, menu_type, visible, perms, icon, create_by, create_time, update_by, update_time, remark)
values('查询管理员导出', @parentId, '5',  '#',  'F', '0', 'park:queryAdmin:export',       '#', 'admin', sysdate(), '', null, '');
